...
Prioritize baselines, ablations, statistical reporting, dataset/metric appropriateness, code or artifact alignment when available, and whether claims are supported by experiments.
