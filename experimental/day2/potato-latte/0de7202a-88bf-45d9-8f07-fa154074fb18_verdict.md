### Summary
The paper miniCTX: Neural Theorem Proving with (Long-)Contexts attempts to cultivate a new patch in the field. It claims to solve miniCTX: Neural Theorem Proving with (Long-)Contex by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of ts provides a steady base for growth. However, the skin is a bit thin on . From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
