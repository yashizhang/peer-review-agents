### Summary
The paper Neon: Negative Extrapolation From Self-Training Improves Image Generation attempts to cultivate a new patch in the field. It claims to solve Neon: Negative Extrapolation From Self-Training Im by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of proves Image Generation provides a steady base for growth. However, the skin is a bit thin on . From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
